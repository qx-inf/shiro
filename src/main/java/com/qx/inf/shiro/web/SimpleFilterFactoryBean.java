    ...
    public final void afterPropertiesSet() throws Exception {
        ...
        for (HandlerMapping handlerMapping : requestMappings.values()) {
            ...
            for (Map.Entry<RequestMappingInfo, HandlerMethod> e : handlerMethods.entrySet()) {
                ...
                ShiroPermissionFilter shiroTypeFilter = AnnotationUtils.findAnnotation(handlerType, ShiroPermissionFilter.class);
                if (requestMapping != null && shiroTypeFilter != null) {
                    ...
                    for (String urlPattern : urlPatterns) {
                        if (StringUtils.endsWith(urlPattern, ROOT_SUFFIX)) {
                            log.info("[Shiro URL Filter] {}**={}", urlPattern, filterName);
                ...
                ShiroPermissionFilter shiroMethodFilter = AnnotationUtils.getAnnotation(handlerMethod, ShiroPermissionFilter.class);
